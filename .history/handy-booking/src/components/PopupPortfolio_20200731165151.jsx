...
const smallImages = [
  require("../../src/assets/img/bath-cleaning"),
  require("../../src/assets/img/carpet-cleaning"),
  require("../../src/assets/img/floor cleaning"),
  require("../../src/assets/img/furniture-cleaning"),
  require("../../src/assets/img/glass-cleaning"),
  require("../../src/assets/img/kitchen——cleaning")
];
